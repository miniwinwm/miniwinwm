...
<H2>MiniWin News</H2>
All the development environments used to build MiniWin have been updated to the latest version. This task is complete. A new release has been made. Here's a summary of progress:
<ul>
