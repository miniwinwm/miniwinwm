...
int main(int argc, char **argv)
{
	...
	if (_mkdir(("../" + json["TargetName"].string_value() + "/common").c_str()) != 0 && errno != EEXIST)
	{
		cout << "Could not make " + json["TargetName"].string_value() + "/common folder.\n";
		exit(1);
	}
	...
	if (mkdir(("../" + json["TargetName"].string_value() + "/common").c_str(), 0777) != 0 && errno != EEXIST)
	{
		cout << "Could not make " + json["TargetName"].string_value() + "/common folder.\n";
		exit(1);
	}
    ...
    std::ifstream infileConfigHeaderSrc("../MiniWin/user/miniwin_config.h_template", std::ios::binary);
    if (infileConfigHeaderSrc.is_open())
    {
		std::ofstream outfileConfigHeaderDst("../" + json["TargetName"].string_value() + "/common/miniwin_config.h",   std::ios::binary);
	...
	std::ofstream outfileUserSource("../" + json["TargetName"].string_value() + "/common/miniwin_user.c");
    ...
    for (auto &window : json["Windows"].array_items())
    {
    	...
    	std::ofstream outfileWindowSource("../" + json["TargetName"].string_value() + "/common/" + windowName + ".c");
    	...
    	std::ofstream outfileWindowHeader("../" + json["TargetName"].string_value() + "/common/" + windowName + ".h");
    ...
    std::ifstream infileMainSourceSrc("../MiniWin/user/main.c_template", std::ios::binary);
    if (infileMainSourceSrc.is_open())
    {
		std::ofstream outfileMainSourceDst("../" + json["TargetName"].string_value() + "/common/main.c", std::ios::binary);
    ...
    std::ifstream infileAppHeaderSrc("../MiniWin/user/app.h_template", std::ios::binary);
	...
	{    
		std::ifstream infileAppSourceSrc("../MiniWin/user/app.c_template_linux", std::ios::binary);
	...
	{
		std::ifstream infileAppSourceSrc("../MiniWin/user/app.c_template_windows", std::ios::binary);
		if (infileAppSourceSrc.is_open())
		{
			std::ofstream outfileAppSourceDst("../" + json["TargetName"].string_value() + "/" + json["TargetType"].string_value() + "/src/app.c", std::ios::binary);
